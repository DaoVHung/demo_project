                    ...
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            ...
                            <a class="navbar-brand"
                               href="<%=request.getContextPath()%>/ContactServlet?action=contacEmail">
                    ...
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/ContactServlet" method="post">
                            ...
                            <table id="example1" class="table table-bordered table-striped text-center">
                                ...
                                <tr>
                                    <td>Phone Number</td>
                                    <td><input type="text" name="phoneNumber" value="${contact.phoneNumber}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                ...
                                <tr>
                                    <td>Address</td>
                                    <td><textarea name="address" cols="80"
