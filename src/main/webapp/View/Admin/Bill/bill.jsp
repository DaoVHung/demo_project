                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand"
                                   href="<%=request.getContextPath()%>/OrderServlet?action=Confirmed">
                                    <button type="button" class="btn btn-outline-dark">Order confirmed</button>
                                </a>
                                <form class="d-flex" role="search" action="<%=request.getContextPath()%>/OrderServlet"
                                      method="post">
                                    <input class="form-control me-2 fst-italic" type="text"
                                           placeholder="Enter product name... "
                                           aria-label="Search" name="search">
                                    <button class="btn btn-outline-danger" type="submit" value="Search" name="action">
                                        Search
                                    </button>
                                </form>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-info">
                                            <a id="update"
                                               href="<%=request.getContextPath()%>/OrderDetailServlet?orderID=${d.orderID}&&action=GetAll"><i
                                                    class="bi bi-list-ol"></i></a>
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-outline-success">
                                            <a id="cinfirm"
                                               href="<%=request.getContextPath()%>/OrderServlet?orderID=${d.orderID}&&action=Update">
...
<selector>
    ...
    <div class="modal fade" id="updateCatalogModal" tabindex="-1" aria-labelledby="updateCatalogLabel"
         aria-hidden="true">
