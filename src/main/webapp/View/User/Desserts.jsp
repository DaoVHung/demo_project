...
<div class="hero-wrap hero-bread" style="background-image: url('<%=request.getContextPath()%>/View/User/images/food-closeup-2111719-wallhere.com.jpg');">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    ...
                    <li><a href="<%=request.getContextPath()%>/ProductServlet?action=GetAllMainFood">Main Food</a></li>
                    ...
                    <li><a href="<%=request.getContextPath()%>/ProductServlet?action=GetAllDesserts"   class="active" >Desserts</a></li>
                </ul>
            </div>
        </div>
