          ...
          <div class="card-header">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
              <div class="container-fluid">
                <a class="navbar-brand" href="<%=request.getContextPath()%>/TableServlet?action=Confirmed">
                  <button type="button" class="btn btn-outline-success">Confirmed</button>
                </a>

                <form class="d-flex" role="search" action="<%=request.getContextPath()%>/TableServlet"
                      method="post">
                  <input class="form-control me-2 fst-italic" type="text"
                         placeholder="Enter product name... "
                         aria-label="Search" name="search">
                  <button class="btn btn-outline-success" type="submit" value="Search" name="action">
                    Search
                  </button>
                </form>
              </div>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-outline-success">
                      <a id="update"
                         href="<%=request.getContextPath()%>/TableServlet?tableID=${d.tableID}&&action=Update"><i class="bi bi-clipboard-check"></i></a>
                    </button>
                  </td>
                </tr>
              </c:forEach>
