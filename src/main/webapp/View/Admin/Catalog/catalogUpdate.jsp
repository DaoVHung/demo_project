                    ...
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/CatalogServlet" method="post">
                            <table id="example1" class="table table-bordered table-striped text-center">
                                <tr>
                                    <td>Catalog ID</td>
                                    <td><input required type="text" name="catalogID" value="${cataUpdate.catalogID}" readonly></td>
                                </tr>
                                <tr>
                                    <td>Catalog Name</td>
                                    <td><input required type="text" name="catalogName" value="${cataUpdate.catalogName}"></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td>
