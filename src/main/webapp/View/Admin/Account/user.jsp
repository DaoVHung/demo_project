                    ...
                    <div class="card-header">
                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                                ...
                                                <div class="card-body">
                                                    <form action="<%=request.getContextPath()%>/UserServlet" method="post">
                                                        <table id="example12" class="table table-bordered table-striped text-center">
                                                            <tr>
                                                                <td colspan="2">
                                                                    <h3> Nhập ID User bạn muốn cập nhật trạng thái</h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>User ID</td>
                                                            ...
                                                            <tr>
                                                                <td>Status</td>
                                                                <td>
                                                                    <input type="radio" name="permission" id="active" value="true"/><label for="active">✔</label>
                                                                    <input type="radio" name="permission" id="inactive" value="false"/><label
                                                                        for="inactive">✖</label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" value="Update" name="action" class="btn btn-outline-success">Save changes</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <form class="d-flex" role="search" action="<%=request.getContextPath()%>/UserServlet" method="post">
                                    <input class="form-control me-2 fst-italic" type="text"
                                           placeholder="Enter User name... "
                                           aria-label="Search" name="UserName">
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${userList}" var="u">
                                <tr>
                                    ...
                                    <td>${u.email}</td>
                                    <td>${u.phoneNumber}</td>
                                    <td>${u.userStatus?"✔️":"✖️"}</td>
                                    <td>
                                        <button type="button" class="btn btn-outline-success">
                                            <a id="update"
                                               href="<%=request.getContextPath()%>/UserServlet?UserID=${u.userID}&&action=Update"><i class="bi bi-gear"></i></a>
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
