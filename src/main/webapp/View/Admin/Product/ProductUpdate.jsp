                    ...
                    <div class="card-body">
                        <form action="<%=request.getContextPath()%>/ProductServlet" method="post"
                            ...
                            <table id="example1" class="table table-bordered table-striped text-center">
                                <tr>
                                    <td colspan="2">
                                        <h3>Nhập thông tin cần cập nhật sản phẩm mới !</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Product ID</td>
                                    <td><input required type="text" name="productID" value="${productUpdate.productID}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Product Name</td>
                                    <td><input required type="text" name="productName" value="${productUpdate.productName}"></td>
                                </tr>
                                <tr>
                                    <td>Catalog ID</td>
                                    <td>
                                        <select name="catalogID" id="cataID" class="form-select"
                                ...
                                <tr>
                                    <td>Price</td>
                                    <td><input required type="text" name="price" value="${productUpdate.price}"></td>
                                </tr>
                                <tr>
                                    <td>Desciption</td>
                                    <td><textarea required name="descriptions" id="descriptions" cols="80"
                                                  rows="5">${productUpdate.description}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td>
                                        ...
                                        <input required type="radio" name="status" id="inactive" value="false"/><label
                                            for="inactive">Inactive</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Discount</td>
                                    <td><input required type="text" name="discount" value="${productUpdate.discount}"></td>
                                </tr>
                                <tr>
                                    <td>Product Image</td>
                                    <td>
                                        <input required type="file" name="productImg"/>
                                        <input required type="hidden" value="${productUpdate.productImg}" name="oldImage"/>

                                        <img src="<%=request.getContextPath()%>/images/${productUpdate.productImg}" alt="">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input required class="btn btn-outline-primary" type="submit" value="Update" name="action">
                                    </td>
                                </tr>
                            </table>
                        </form>
